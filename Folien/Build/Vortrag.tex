...
\section{Historische Kaonenexperimente}
      ...
      \begin{column}{0.5\textwidth}
        \begin{itemize}
          ...
          \begin{equation*}
            ...
            \end{cases}
          \end{equation*}
          \item Dabei ist $\ket{K_1} = \ket{K_{s}}$ und $\ket{K_2} = \ket{K_{l}}$, mit $\tau(\ket{K_{l}}) \approx 600 \times \tau(\ket{K_{s}})$
  ...
  \begin{frame}{Mischung neutraler Kaonen}
    \begin{figure}[ht]
      \centering
