...
\end{frame}
  ...
  \begin{frame}{Ereignis und Veto}
    \begin{itemize}
      ...
      \item[\rightarrow] Tracking aller Teilchen durch Pixeldetektor%Damit man weiß wenn andere teilchen in Kaonen zerfallen 100ps Zeitauflösung
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Präzise Messung von BR($K \rightarrow \pi \nu \bar{\nu}$)
      \item Wichtig beide Zerfallsmoden zu vermessen %K+ KL
      \item[\rightarrow] Unterschiedliche Beeinflussung durch verschiedene Modelle für neue Physik
