  ...
  \begin{frame}{CP-Verletzung}
    \begin{columns}[onlytextwidth]
      \begin{column}{0.4\textwidth}
        \begin{figure}[ht]
          \begin{center}
            \includegraphics[height=0.6\textheight]{Images/croninfitch_b.png} %Zuschnippeln
    ...
    \begin{columns}[onlytextwidth]
      ...
      \begin{column}{0.6\textwidth}
        \begin{itemize}
          ...
          %\item Vertexrekonstruktion für $\pi^{\pm}$
          %\begin{align*}
          %  K_S \rightarrow \pi^0 \pi^0 \rightarrow \gamma \gamma \gamma \gamma
          %\end{align*}
