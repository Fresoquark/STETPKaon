    ...
    \begin{columns}[onlytextwidth]
      ...
      \begin{column}{0.5\textwidth}
        \begin{itemize}
          ...
          \item Für gleich wichtig: $\ket{K_{s}}$ hat CP = +1 und $\ket{K_{l}}$ hat CP =-1
    ...
    \begin{columns}[onlytextwidth]
      ...
      \begin{column}{0.5\textwidth}
        \begin{itemize}
          ...
          \item Hauptsächlich wird der Winkel $\theta$ zwischen dem $K_{l}^{0}$-Strahl und den Teilchenimpulsen gemssen.
          \item Treffen zwei Teilchen 'gleichzeitig' den Detektor so kann die Summe der Winkel bestimmt werden
