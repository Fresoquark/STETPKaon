      ...
      \begin{column}{0.4\textwidth}
        \begin{figure}[ht]
          \begin{center}
            ...
            %\caption{Nebelkammeraufnahme der kosmischen Höhenstrahlung von Rochester und Butler 1947\cite[4]{Ceccucci1}}
...
\subsection{Direkte und indirekte CP-Verletzung}
  ...
  \begin{frame}{Wie kann das sein?}
    \begin{itemize}
      ...
      \begin{align*}
        ...
        |\epsilon| &= (2.229\pm0.010)\times10^{-3}
      \end{align*}
      \item Auftreten von Cp-Verletzung durch Oszillation (indirekt) oder innerhalb eines Zerfalls (direkt)
      \item Problem: Im Jahre 1964 noch keine Quarks oder der CKM-Mechanismus bekannt
      \item[\rightarrow] Es war nur Mischprozess mit komplexer Phase bekannt
  ...
  \begin{frame}{Wie wird das gemessen?}
    \begin{columns}[onlytextwidth]
      ...
      \begin{column}{0.5\textwidth}
        \begin{itemize}
          \item Messung der partiellen Zerfallsbreiten
...
\subsection{Aufbau des NA48-Detektors}
  ...
  \begin{frame}{Heliumtank}
    \begin{itemize}
      ...
      \item Verhindern von Streuung an Molekülen
...
\end{frame}
  ...
  \begin{frame}{Ereignis und Veto}
    \begin{itemize}
      ...
      \item Sekundärer Strahl wird durch Cherenko-Detektor auf Kaonen mit $\SI{75}{\giga\electronvolt}$ selektiert
      \item[\rightarrow] Tracking aller Teilchen durch Pixeldetektor(GTK)%Damit man weiß wenn andere teilchen in Kaonen zerfallen 100ps Zeitauflösung
      ...
      \item STRAWS (Tracking Detektoren) innerhalb des Vakuums um Streuprozesse zu verhindern %Luft
  ...
  \begin{frame}{Nach den vetoes, wie misst man den richtigen Zerfall?}
      \begin{columns}[onlytextwidth]
        \begin{column}{0.5\textwidth}
          \begin{figure}[ht]
            \begin{center}
              \includegraphics[width=0.9\textwidth]{Images/na62missing.png} %Zuschnippeln
        ...
        \begin{column}{0.5\textwidth}
          \begin{figure}[ht]
            \begin{center}
              \includegraphics[height=0.6\textheight]{Images/na62knick.png} %Zuschnippeln
  ...
  \begin{frame}{Das KOTO-Experiment}
    \begin{columns}[onlytextwidth]
      \begin{column}{0.4\textwidth}
        \begin{figure}[ht]
          \begin{center}
            \includegraphics[width=0.9\textwidth]{Images/jparclogo.png} %Zuschnippeln
          \end{center}
        \end{figure}
      \end{column}
      \begin{column}{0.5\textwidth}
        \begin{itemize}
          %\item KOTO\cite{KOTOPress}: K0 at Tokai
  ...
  %  KLOE II
  %  \begin{itemize}
  %    %\item Experiment am DA\textphi NE-Bechleuniger am INFN Frascate National Laboratory
  %    %\item $e^+e^-$-Beschleuniger
  %    %\item[\rightarrow] Operiert an Massenresonanz des \textphi-Mesons @ $\SI{1019}{\mega\electronvolt}$
  %    %\item[\rightarrow] \textphi fast in Ruhe
